...
![example branch parameter](https://github.com/arnopensource/gotrue-go/actions/workflows/test.yaml/badge.svg?branch=main)
[![codecov](https://codecov.io/gh/arnopensource/gotrue-go/branch/main/graph/badge.svg?token=JQQJKETMRX)](https://codecov.io/gh/arnopensource/gotrue-go)
![GitHub](https://img.shields.io/github/license/arnopensource/gotrue-go)
[![Go Reference](https://pkg.go.dev/badge/github.com/arnopensource/gotrue-go.svg)](https://pkg.go.dev/github.com/arnopensource/gotrue-go)
...
```sh
go get github.com/arnopensource/gotrue-go
```
...
import "github.com/arnopensource/gotrue-go"
